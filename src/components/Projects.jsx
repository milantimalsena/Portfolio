...
const projects = [
  ...
  },
  {
    ...
    tech: ['React', 'Node.js', 'Express', 'JavaScript', 'Tailwind CSS', 'cPanel'],
    ...
    solution: 'Deployed a dedicated civic web platform on production cPanel hosting providing interactive vision roadmaps, localized typography, community engagement channels, and milestone tracking.',
    contribution: 'Contributed across the full stack: co-designed UI wireframes, developed responsive React views, integrated backend API endpoints, and managed cPanel production deployment.',
  ...
  },
  {
    ...
    solution: 'Launched a news broadcasting web portal with live TV streaming, article categorization, and breaking news alerts on cPanel server hosting.',
    contribution: 'Delivered full-stack components: implemented live video player integrations, responsive typography, backend news APIs, and cPanel server hosting configuration.',
  ...
  },
  {
    ...
    tech: ['React', 'Node.js', 'MongoDB', 'Tailwind CSS', 'cPanel'],
    ...
    solution: 'Built a regional marketplace featuring cultural travel itineraries, vendor showcases, and event announcements on live production hosting.',
    contribution: 'Designed card component structures, implemented backend data fetching, built responsive layout grids, and assisted in cPanel deployment.',
  ...
  },
  {
    ...
    tech: ['React', 'JavaScript', 'Tailwind CSS', 'REST API', 'cPanel'],
    ...
    solution: 'Deployed a production tourism portal on cPanel hosting featuring tour package listings, gallery showcases, and direct travel inquiry forms.',
    contribution: 'Developed responsive frontend interfaces, optimized image rendering performance, integrated query APIs, and managed cPanel live deployment.',
